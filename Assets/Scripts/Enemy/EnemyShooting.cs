...
public class EnemyShooting : MonoBehaviour {
    ...
    void OnAnimatorIK(int layerIndex) {
        ...
        anim.SetIKPosition(AvatarIKGoal.RightHand, player.GetComponent<ThirdPersonCharacter>().transform.position);
    ...
    void Shoot() {
        ...
        float fractionalDistance = (col.radius - Vector3.Distance(transform.position, player.GetComponent<ThirdPersonCharacter>().transform.position)) / col.radius;
    ...
    void ShotEffects() {
        ...
        //laserShotLine.SetPosition(1, player.GetComponent<ThirdPersonCharacter>().transform.position);
